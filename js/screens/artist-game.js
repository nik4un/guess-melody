...
import gameGenre from './genre-game';
import showScreen from '../utils/showScreen';

const block = `<section class="main main--level main--level-artist">
...
const onClickAnswer3 = () => {
  showScreen(gameGenre);
};

element.querySelector(`#answer-1`).addEventListener(`click`, onClickAnswer1);
element.querySelector(`#answer-2`).addEventListener(`click`, onClickAnswer2);
element.querySelector(`#answer-3`).addEventListener(`click`, onClickAnswer3);
